                                                                    ...
                                                                    <div class="navbar-inner">
                                                                        <div class="container-fluid">
                                                                            ...
                                                                            <% if (appLogo == null || "".equals(appLogo)) { %>
                                                                                <a class="navbar-brand" href="<%= appHome %>">
                                                                                    <%= appName %>
                                                                                </a>
                                                                                <% } else { %>
                                                                                    <a class="navbar-brand-logo" href="<%= appHome %>">
              <img src="<%= appLogo %>">
            </a>
                                                                                    <% } %>
                                                                                        <% if (!"left".equals(appMenu)) { %>
                                                                                            <ul class="nav hidden-xs" data-nav-menu-bar></ul>
                                                                                            <% } %>
                                                                                                <ul class="nav nav-shortcuts pull-right">
                                                                                                    ...
                                                                                                    <li class="divider-vertical"></li>
                                                                                                    <li>
                                                                                                        <a href="" class="nav-link-mail" ng-click="showMailBox()"><i class="fa fa-envelope"></i><sup
                                                                    ...
                                                                    <% } else { %>
                                                                        ...
                                                                        <% } %>
                                                                            <div ng-switch-when="about">
                                                                                <div ng-include x-src="'partials/about.html'"></div>
                                                                            </div>
                                                                            <div ng-switch-when="system">
                                                                                <div ng-include x-src="'partials/system.html'"></div>
                                                                            </div>
                                                                            <div ng-switch-when="welcome">
                                                                                <div ng-include x-src="'partials/welcome.html'"></div>
                                                                            </div>
                                                                            <div ng-switch-when="preferences">
                                                                                <div ng-include x-src="'partials/preferences.html'"></div>
                                                                            </div>
                                                            </section>
