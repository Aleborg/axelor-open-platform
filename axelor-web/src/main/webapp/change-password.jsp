                                                                            ...
                                                                            <form id="login-form" action="<%=callbackUrl%>" method="POST">
                                                                                <div class="form-fields">
                                                                                    <div class="input-group">
                                                                                        ...
                                                                                        <input type="text" id="usernameId" name="username" placeholder="<%= loginUserName %>" required="required" value="<%= request.getParameter(" username ") %>" readonly="readonly">
                                                                                    </div>
                                                                                    <div class="input-group">
                                                                                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                                                                        <input type="password" id="passwordId" name="password" placeholder="<%= loginPassword %>" required="required" autofocus="autofocus" oninput="checkPasswordInputs()">
                                                                                    </div>
                                                                                    <div class="input-group">
                                                                                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                                                                        <input type="password" id="newPasswordId" name="newPassword" placeholder="<%= newPassword %>" required="required" oninput="checkPasswordInputs()">
                                                                                    </div>
                                                                                    <div class="input-group">
                                                                                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                                                                        <input type="password" id="confirmPasswordId" name="confirmPassword" placeholder="<%= confirmPassword %>" required="required" oninput="checkPasswordInputs()">
                                                                                    </div>
